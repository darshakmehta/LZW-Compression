...
class Compressing {
	public static void main(String arg[]) {
			...
			/***
				HashMap<KEY,VALUE> initialized with code for individual characters
				KEY = ASCII Character
				VALUE = ASCII Value
			***/
			...
			String inputFileName = arg[0]; //1st parameter in the command line is the input file name
			...
			/***
				Read the input file and store in a strin
			***/
            ...
            /***
				Continue reading characters until End of File, and check if contains in dictionary, if not present make an entry and update the encodeString to symbol
            ***/
